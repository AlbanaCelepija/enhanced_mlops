...
from temlops.src.artifact_types import Data, Configuration, Report, Status, Documentation
from temlops.use_cases.tabular.src.dh_platform.platform_artifacts import DataPlatform
